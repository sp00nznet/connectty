...
import type { ServerConnection, Credential, ConnectionGroup, ImportOptions, ExportOptions, SSHSessionEvent } from '@connectty/shared';
...
const api = {
  ...
  // SSH operations
  ssh: {
    connect: (connectionId: string): Promise<string> => ipcRenderer.invoke('ssh:connect', connectionId),
